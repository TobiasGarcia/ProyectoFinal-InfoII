...
#include "../../ProyectoFinal/levels_menu/needle.h"
...
QT_MOC_LITERAL(1, 7, 6), // "finish"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 4) // "move"

    },
    "Needle\0finish\0\0move"
};
...
void Needle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Needle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Needle::finish)) {
                *result = 0;
                return;
            }
        }
