...
#include "../../ProyectoFinal/level/base.h"
...
QT_MOC_LITERAL(1, 5, 9), // "no_health"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 6), // "bitten"
QT_MOC_LITERAL(4, 23, 13), // "return_normal"
QT_MOC_LITERAL(5, 37, 11) // "vulture_hit"

    },
    "Base\0no_health\0\0bitten\0return_normal\0"
    "vulture_hit"
};
...
void Base::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->no_health(); break;
        case 1: _t->bitten(); break;
        case 2: _t->return_normal(); break;
        case 3: _t->vulture_hit(); break;
        default: ;
        }
        ...
        {
            using _t = void (Base::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Base::no_health)) {
                *result = 0;
                return;
            }
        }
